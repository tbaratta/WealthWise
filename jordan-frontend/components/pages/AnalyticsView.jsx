// AnalyticsView.jsimport React, { useState } from 'react';import { View, Text, Button, TextInput, FlatList, StyleSheet, ScrollView } from 'react-native';
const AnalyticsView = () => {
     ...
     return (
          <ScrollView style={styles.container}><View style={styles.header}><Text style={styles.headerText}>Analytics</Text></View><View style={styles.section}><Text style={styles.header}>Spending</Text>
               {/* Placeholder for Pie Chart */}                <View style={styles.chartPlaceholder}><Text style={styles.chartText}>📊 Pie Chart Placeholder</Text></View><Button title={showTransactions ? "Hide Transactions" : "Show Recent Transactions"} onPress={toggleTransactions} />
               {showTransactions && (
                    <FlatList
     ...
     container: {
          ...
          backgroundColor: '#FFA500', // Orange colorpadding: 16,
     }, headerText: {
          fontSize: 20,
          fontWeight: 'bold',
          color: '#fff',
